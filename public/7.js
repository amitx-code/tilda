  ...
  data: function data() {
    ...
    return {
      ...
      menuItems: [{
        ...
        cmd: function cmd() {
          _this.$store.dispatch('tree/save').then(function () {
            _this.$snackbar.open({
              message: 'Saved'
            });
          });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    save: function save() {
      ...
      this.data.method = 'save', axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(Object(_route__WEBPACK_IMPORTED_MODULE_7__["default"])("pages.update"), this.data).then(function (response) {
        if (response.data.result) {
          _this2.$fire({
            text: "Сохранено",
            type: "success"
      ...
      _c("div", { staticClass: "columns" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("pre", { staticStyle: { "max-width": "80vw" } }, [
              _vm._v("      " + _vm._s(_vm.$store.state.tree.root) + "\n      ")
            ])
          ],
          1
        ),
...
var render = function() {
  ...
  return _c("div", [
    _vm.node
      ? _c("div", { staticClass: "modal-card modal-editor" }, [
